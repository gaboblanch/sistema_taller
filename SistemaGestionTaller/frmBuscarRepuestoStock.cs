...
{
    public partial class frmBuscarRepuestoStock : Form
    {
        ...
        public frmBuscarRepuestoStock(ArrayList colRepuestosDetalle_p, int idProveedor_p)
        {
            InitializeComponent();
        ...
        private void llenarListBox()
        {
            ...
            if (this.comboBoxBuscar.SelectedIndex == 1)
            {
                ...
                colRepuestos = repuesto.coleccion(idProveedor);
            }
            else
            {
                //BUSCAR POR CODIGO
                colRepuestos = repuesto.coleccionCodigo(idProveedor);
            }
        ...
        private void frmBuscarRepuestoStock_Load(object sender, EventArgs e)
        {
